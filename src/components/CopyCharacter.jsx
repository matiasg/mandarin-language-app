  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold text-gray-800">Copy the Character</h1>
        <p className="text-gray-600">Draw the character shown below in the canvas.</p>
      </div>
      ...
      <Card className="border-2">
        <CardHeader className="text-center">
          <CardTitle className="text-lg">Character to Copy</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="text-center">
            <div className="text-8xl font-bold text-gray-800 mb-2" style={{ fontFamily: 'Noto Sans CJK SC, serif' }}>
              {currentCharacter.simplified}
            </div>
            <p className="text-xl text-gray-600">{currentCharacter.meaning}</p>
            <p className="text-sm text-gray-500">Pinyin: {currentCharacter.pinyin}</p>
          </div>
        </CardContent>
      </Card>
